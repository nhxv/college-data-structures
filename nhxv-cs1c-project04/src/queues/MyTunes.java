...
public class MyTunes 
{
	...
	public MyTunes(String requestedFile, SongEntry[] allSongs)
	{
		...
		jukebox = new Jukebox(namesOfPlayLists[0], namesOfPlayLists[1], namesOfPlayLists[2]);
	...
	public static void main(String[] args) 
	{
		...
		final String TESTFILE = "resources/myTunes.txt";	// Directory path for plain-text file
