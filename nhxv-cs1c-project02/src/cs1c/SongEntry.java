 ...
 * 
 * @author CS1C, Foothill College, Vinh Ngo
 * @version 1.0
 */
public class SongEntry implements Comparable<SongEntry>
{
	...
	// avoid duplicate song in playlist
	@Override
	public boolean equals(Object o) {
		if (this == o) return true;
		if (o == null || getClass() != o.getClass()) return false;
		SongEntry songEntry = (SongEntry) o;
		return Objects.equals(title, songEntry.title) &&
				Objects.equals(artist, songEntry.artist);
	}
